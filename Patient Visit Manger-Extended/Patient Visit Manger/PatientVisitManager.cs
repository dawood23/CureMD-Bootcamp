    ...
    public class PatientVisitManager
    {
        ...
        private void SaveDataToFile()
        {
            try
            {
                ...
                lines.Add("Id,PatientName,VisitDate,VisitType,Description,DoctorName,VisitDuration,Fee");
        ...
        private void CreateSampleData()
        {
            ...
            for (int i = 0; i < 400; i++)
            {
                ...
                visit.VisitDuration = random.Next(59) + 1;

                visit.Fee = visit.VisitDuration * FeeConfigLoader.GetFeeForVisitType(visit.VisitType);
                visits.Add(visit);
            }
        ...
        public void UpdateVisit(int id, PatientVisit updatedVisit)
        {
            ...
            if (existingVisit != null)
            {
                PatientVisit oldVisit = new PatientVisit(
                    ...
                    existingVisit.VisitType, existingVisit.Description, existingVisit.DoctorName, existingVisit.VisitDuration, existingVisit.Fee
                );

                updatedVisit.Fee = updatedVisit.VisitDuration * FeeConfigLoader.GetFeeForVisitType(updatedVisit.VisitType);
                updatedVisit.Id = id;
        ...
        public void DeleteVisit(int id)
        {
            ...
            if (visitToDelete != null)
            {
                PatientVisit deletedVisit = new PatientVisit(
                    ...
                    visitToDelete.VisitType, visitToDelete.Description, visitToDelete.DoctorName, visitToDelete.VisitDuration, visitToDelete.Fee
                );
